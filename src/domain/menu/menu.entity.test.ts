...
describe("Test Menu Test", () => {
  ...
  //   menu.updateSkills(skills);
  //   
  //   expect(menu.skills).toHaveLength(1)
  //   expect(menu.skills).toStrictEqual(skills);
  // });
  ...
  //   expect(menu.image).toStrictEqual(image);
  // });
  ...
  //   };
  //   const menu = new Menu(menuData);
  //   menu.updateDescription("new description");
